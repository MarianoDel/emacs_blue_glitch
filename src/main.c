...
#endif    //GLITCHER_SYNCHRONIZE_TO_SERIAL
    ...
    while (1)
    {
        ...
        case PROG_MEM_READ:
            if (usart3_have_data)
            {
                ...
                {
                    prog_state = PROG_MEM_READ_1;
                    timer_standby = 100;    //doy algunos ms
                    error = 0;
                }
        ...
        case PROG_MEM_READ_1:
            //leo respuestas durante algunos ms
            if (usart3_have_data)
            {
                usart3_have_data = 0;
            ...
            if (!timer_standby)
            {
                //blanqueo el READ
                Usart3Send("OK\r\n");
                prog_state = PROG_MEM_READ_2;
                timer_standby = 100;    //doy algunos ms
            }
            
            break;

        case PROG_MEM_READ_2:
            //leo respuestas durante algunos ms
            if (usart3_have_data)
            {
                usart3_have_data = 0;
